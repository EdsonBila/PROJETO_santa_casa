<nav class="navbar navbar-expand-lg" style="background-color: #ebf6f9;">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end navbar-menu" id="menu">
            <ul class="navbar-nav">
                <li class="nav-item btn-navbar home-nav-item">
                    <a class="nav-link" href="{{ route('home.index') }}"><img class="icon-menu" src="{{ asset('assets/icons/home.svg') }}" alt="icone Home">Home</a>
                </li>
                <li class="nav-item btn-navbar medico-nav-item">
                ...
                <li class="nav-item btn-navbar relatorio-nav-item">
                    <a class="nav-link" href="{{ route('relatorio.index') }}"><img class="icon-menu" src="{{ asset('assets/icons/relatorio.svg') }}" alt="icone Relatorio">Relatório</a>
                </li>
                <li class="nav-item btn-navbar especialidade-nav-item">
